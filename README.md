...
```
{
    ...
    "subsets":   list of PAQ subsets the question apears in ("L1", "L4" or "NE")
...
```
{
    "question":  question string
    "subsets":   list of PAQ subsets the question apears in ("L1", "L4" or "NE")
    "consistent_subsets":  list of PAQ subsets the question apears in, which pass the consistnency filters ("L1", "L4" or "NE")
